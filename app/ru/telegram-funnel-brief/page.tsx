...
import TelegramFunnelBriefForm from "@/components/telegram-funnel-brief-form"
      ...
      <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 py-12 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-4xl mx-auto">
          <h1 className="text-4xl font-extrabold text-center text-slate-900 mb-4">
            📋 Бриф на запуск автоворонки в Telegram через Leeloo.ai
          </h1>
          <p className="text-lg text-center text-slate-600 mb-12">
            Заполните форму ниже, чтобы мы могли создать эффективную автоворонку для вашего бизнеса
          </p>
          <TelegramFunnelBriefForm language={language} t={t} />
        </div>
      </main>
