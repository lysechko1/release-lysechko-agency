...
import GroomingSalonBriefForm from "@/components/grooming-salon-brief-form"
import { Mail, Phone } from "lucide-react"
import { useTranslation } from "@/lib/i18n"

export default function GroomingSalonBriefPage() {
      ...
      <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 py-12 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-4xl mx-auto">
          ...
          <p className="text-lg text-center text-slate-600 mb-12">
            Заполните форму ниже, чтобы мы могли предложить вам оптимальную стратегию продвижения
          </p>
          <GroomingSalonBriefForm language={language} t={t} />
        </div>
      </main>
